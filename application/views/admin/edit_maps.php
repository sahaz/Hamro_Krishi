...
<h1>ADD MAPs:</h1><br>
<form class="form-horizontal" id="baseform" action="<?php echo site_url('admin/con_maps/process_edit_maps/'.$r->id);?>" method="POST" enctype="multipart/form-data" >
   
   <div class="form-group">
      <label class="col-sm-3 control-label">Name of the MAP:</label>
      <div class="col-sm-6">
      <input type="text" name="maps_name" id="maps_name" value="<?php echo $r->maps_name; ?>" class="required form-control" />
      </div>
   </div>
 ...
 <div class="form-group">
      ...
      <div class="col-sm-6">
        <textarea rows="4" cols="30" name="maps_description" id="maps_description" class="required form-control"><?php echo $r->maps_description; ?></textarea>
      </div>
   </div>
  ...
  <input type="submit" class="btn btn-info" id="submit" name="submit" value="UPLOAD" /><br><br>
        <input type="hidden" id="hidden" name="hidden" value="<?php echo $r->maps_image;?>" /><br><br>      
        </div>
        </div>
